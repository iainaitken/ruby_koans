...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Some research (https://stackoverflow.com/questions/4658269/ruby-send-vs-send)
    # indicates that the reason is, the send method may be overridden by a bespoke
    # send method in a class. __send__ is not overridden in this way, and works
    # with all classes.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # I don't know. My guess is that we could amend how the method works and
    # eliminate the NoMethodError.
    #
    # NOTE:
    #
