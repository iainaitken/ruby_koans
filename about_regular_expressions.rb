...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # I'm not sure * in itself would ever fail to match, as * will always accept
    # an empty string. It may fail to match in conjunction with other characters,
    # if those other characters are not present, but that seems to me to be a case
    # of those other characters failing to match, rather than *.
  end
  ...
  #
  # Why?
  # Greedy means that the regex engine will try to match as many of the preceding
  # expression as possible. Non-greedy means that the engine will try and match
  # the expression a limited number of times.
  # ------------------------------------------------------------------
