...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject iterates through the array, reducing the elements down to a single
    # number by applying the code in the following block to each element. The
    # integer passed into the method as an argument is the starting value; this
    # is why for a product the starting value should be 1 (if it was zero then
    # the end result would alwys be zero).
  end
